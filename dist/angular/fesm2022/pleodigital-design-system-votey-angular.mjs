...
import { InjectionToken, inject, PLATFORM_ID, Injectable, makeEnvironmentProviders, provideEnvironmentInitializer, input, ChangeDetectionStrategy, Component, Pipe, numberAttribute, computed, output, viewChildren, signal, Input, Directive, model, forwardRef, ViewEncapsulation, booleanAttribute, viewChild, TemplateRef, contentChildren } from '@angular/core';
...
import { FormControl, NG_VALUE_ACCESSOR, Validators, ReactiveFormsModule } from '@angular/forms';
...
class VoteyFormControlApplyDirective {
    ...
    handleFormControlValueChange(_value) { }
    handleFormControlDisabledChange(_disabled) { }
    observeFormControl() {
        this.valueChangesSubscription = this.formControl.valueChanges.subscribe((value) => this.handleFormControlValueChange(value));
        this.statusChangesSubscription = this.formControl.statusChanges.subscribe(() => this.handleFormControlDisabledChange(this.formControl.disabled));
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyFormControlApplyDirective, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { staticValue: [{
                type: Input
            }], initialValue: [{
                type: Input
            }], control: [{
...
class VoteyCheckboxComponent extends VoteyFormControlApplyDirective {
    ...
    handleFormControlValueChange(value) {
        this.checked.set(Boolean(value));
    }
    handleFormControlDisabledChange(disabled) {
...
class VoteyFilePickerComponent extends VoteyFormControlApplyDirective {
    ...
    hasFile = computed(() => this.selectedFile() !== null || this.filename().trim().length > 0, ...(ngDevMode ? [{ debugName: "hasFile" }] : /* istanbul ignore next */ []));
    resolvedFilename = computed(() => this.selectedFile()?.name || this.filename().trim(), ...(ngDevMode ? [{ debugName: "resolvedFilename" }] : /* istanbul ignore next */ []));
    effectiveDisabled = computed(() => this.disabled() || this.formDisabled(), ...(ngDevMode ? [{ debugName: "effectiveDisabled" }] : /* istanbul ignore next */ []));
    isRequired = computed(() => {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyFilePickerComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: VoteyFilePickerComponent, isStandalone: true, selector: "vt-file-picker", inputs: { filename: { classPropertyName: "filename", publicName: "filename", isSignal: true, isRequired: false, transformFunction: null }, label: { classPropertyName: "label", publicName: "label", isSignal: true, isRequired: false, transformFunction: null }, emptyText: { classPropertyName: "emptyText", publicName: "emptyText", isSignal: true, isRequired: false, transformFunction: null }, actionText: { classPropertyName: "actionText", publicName: "actionText", isSignal: true, isRequired: false, transformFunction: null }, disabled: { classPropertyName: "disabled", publicName: "disabled", isSignal: true, isRequired: false, transformFunction: null }, name: { classPropertyName: "name", publicName: "name", isSignal: true, isRequired: false, transformFunction: null }, accept: { classPropertyName: "accept", publicName: "accept", isSignal: true, isRequired: false, transformFunction: null }, capture: { classPropertyName: "capture", publicName: "capture", isSignal: true, isRequired: false, transformFunction: null }, dataCy: { classPropertyName: "dataCy", publicName: "dataCy", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { changed: "changed", cancelled: "cancelled" }, viewQueries: [{ propertyName: "fileInput", first: true, predicate: ["fileInput"], descendants: true, isSignal: true }], usesInheritance: true, ngImport: i0, template: "<div\n  class=\"file-picker-wrapper\"\n  [class.disabled]=\"effectiveDisabled()\"\n  [class.filled]=\"hasFile()\"\n>\n  @if (label()) {\n  <vt-text variant=\"label\" color=\"secondary\" [content]=\"label()\" />\n  }\n\n  <div class=\"row\">\n    <div class=\"file-box\" aria-live=\"polite\" [attr.title]=\"resolvedFilename()\">\n      <vt-text\n        variant=\"caption\"\n        [color]=\"hasFile() ? 'primary' : 'muted'\"\n        [content]=\"\n          resolvedFilename() ? resolvedFilename() : (emptyText() | vtTranslate)\n        \"\n      />\n    </div>\n\n    <vt-button\n      variant=\"ghost\"\n      [text]=\"actionText()\"\n      [disabled]=\"effectiveDisabled()\"\n      (pressed)=\"open()\"\n    />\n\n    <input\n      #fileInput\n      type=\"file\"\n      hidden\n      [name]=\"name()\"\n      [disabled]=\"effectiveDisabled()\"\n      [required]=\"isRequired()\"\n      [attr.accept]=\"accept() || null\"\n      [attr.capture]=\"capture() || null\"\n      [attr.data-cy]=\"dataCy() || null\"\n      (change)=\"handleChange($event)\"\n      (cancel)=\"handleCancel()\"\n    />\n  </div>\n</div>\n", styles: [":host{display:contents}.file-picker-wrapper{display:flex;flex-direction:column;align-items:stretch;gap:var(--spacing-8);width:100%}.file-picker-wrapper .row{position:relative;display:flex;align-items:center;gap:var(--spacing-12);width:100%;height:100px;overflow:hidden}.file-picker-wrapper .row .file-box{display:flex;flex:1 1 0;align-items:center;min-width:0;height:50px;padding:0 var(--spacing-16);overflow:hidden;border-radius:var(--radius-input);background-color:var(--color-bg-surface-tint)}\n"], dependencies: [{ kind: "component", type: VoteyTextComponent, selector: "vt-text", inputs: ["content", "variant", "color", "uppercase", "italic", "wrap", "maxLines"] }, { kind: "component", type: VoteyButtonComponent, selector: "vt-button", inputs: ["disabled", "type", "variant", "size", "text", "ico", "badge", "tooltipText", "disabledNote"], outputs: ["pressed"] }, { kind: "pipe", type: VoteyTranslatePipe, name: "vtTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyFilePickerComponent, decorators: [{
            type: Component,
            args: [{ selector: "vt-file-picker", changeDetection: ChangeDetectionStrategy.OnPush, imports: [VoteyTextComponent, VoteyTranslatePipe, VoteyButtonComponent], template: "<div\n  class=\"file-picker-wrapper\"\n  [class.disabled]=\"effectiveDisabled()\"\n  [class.filled]=\"hasFile()\"\n>\n  @if (label()) {\n  <vt-text variant=\"label\" color=\"secondary\" [content]=\"label()\" />\n  }\n\n  <div class=\"row\">\n    <div class=\"file-box\" aria-live=\"polite\" [attr.title]=\"resolvedFilename()\">\n      <vt-text\n        variant=\"caption\"\n        [color]=\"hasFile() ? 'primary' : 'muted'\"\n        [content]=\"\n          resolvedFilename() ? resolvedFilename() : (emptyText() | vtTranslate)\n        \"\n      />\n    </div>\n\n    <vt-button\n      variant=\"ghost\"\n      [text]=\"actionText()\"\n      [disabled]=\"effectiveDisabled()\"\n      (pressed)=\"open()\"\n    />\n\n    <input\n      #fileInput\n      type=\"file\"\n      hidden\n      [name]=\"name()\"\n      [disabled]=\"effectiveDisabled()\"\n      [required]=\"isRequired()\"\n      [attr.accept]=\"accept() || null\"\n      [attr.capture]=\"capture() || null\"\n      [attr.data-cy]=\"dataCy() || null\"\n      (change)=\"handleChange($event)\"\n      (cancel)=\"handleCancel()\"\n    />\n  </div>\n</div>\n", styles: [":host{display:contents}.file-picker-wrapper{display:flex;flex-direction:column;align-items:stretch;gap:var(--spacing-8);width:100%}.file-picker-wrapper .row{position:relative;display:flex;align-items:center;gap:var(--spacing-12);width:100%;height:100px;overflow:hidden}.file-picker-wrapper .row .file-box{display:flex;flex:1 1 0;align-items:center;min-width:0;height:50px;padding:0 var(--spacing-16);overflow:hidden;border-radius:var(--radius-input);background-color:var(--color-bg-surface-tint)}\n"] }]
        }], propDecorators: { filename: [{ type: i0.Input, args: [{ isSignal: true, alias: "filename", required: false }] }], label: [{ type: i0.Input, args: [{ isSignal: true, alias: "label", required: false }] }], emptyText: [{ type: i0.Input, args: [{ isSignal: true, alias: "emptyText", required: false }] }], actionText: [{ type: i0.Input, args: [{ isSignal: true, alias: "actionText", required: false }] }], disabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], name: [{ type: i0.Input, args: [{ isSignal: true, alias: "name", required: false }] }], accept: [{ type: i0.Input, args: [{ isSignal: true, alias: "accept", required: false }] }], capture: [{ type: i0.Input, args: [{ isSignal: true, alias: "capture", required: false }] }], dataCy: [{ type: i0.Input, args: [{ isSignal: true, alias: "dataCy", required: false }] }], changed: [{ type: i0.Output, args: ["changed"] }], cancelled: [{ type: i0.Output, args: ["cancelled"] }], fileInput: [{ type: i0.ViewChild, args: ["fileInput", { isSignal: true }] }] } });
...
class VoteyTextareaComponent {
    fallbackId = `vt-textarea-${++nextTextareaId}`;
    formDisabled = signal(false, ...(ngDevMode ? [{ debugName: "formDisabled" }] : /* istanbul ignore next */ []));
    ...
    showHelper = input(true, { ...(ngDevMode ? { debugName: "showHelper" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    disabled = input(false, { ...(ngDevMode ? { debugName: "disabled" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    ...
    blurred = output();
    keyDown = output();
    textareaElement = viewChild("textareaElement", ...(ngDevMode ? [{ debugName: "textareaElement" }] : /* istanbul ignore next */ []));
    effectiveDisabled = computed(() => this.disabled() || this.formDisabled(), ...(ngDevMode ? [{ debugName: "effectiveDisabled" }] : /* istanbul ignore next */ []));
    ...
    textareaClasses = computed(() => [
        ...
        .filter(Boolean)
        .join(" "), ...(ngDevMode ? [{ debugName: "textareaClasses" }] : /* istanbul ignore next */ []));
    onChange = () => undefined;
    onTouched = () => undefined;
    writeValue(value) {
    ...
    handleBlur(event) {
        const textareaElement = event.target;
        const trimmedValue = textareaElement.value.trim();
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyTextareaComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: VoteyTextareaComponent, isStandalone: true, selector: "vt-textarea", inputs: { value: { classPropertyName: "value", publicName: "value", isSignal: true, isRequired: false, transformFunction: null }, label: { classPropertyName: "label", publicName: "label", isSignal: true, isRequired: false, transformFunction: null }, placeholder: { classPropertyName: "placeholder", publicName: "placeholder", isSignal: true, isRequired: false, transformFunction: null }, helper: { classPropertyName: "helper", publicName: "helper", isSignal: true, isRequired: false, transformFunction: null }, showLabel: { classPropertyName: "showLabel", publicName: "showLabel", isSignal: true, isRequired: false, transformFunction: null }, showHelper: { classPropertyName: "showHelper", publicName: "showHelper", isSignal: true, isRequired: false, transformFunction: null }, disabled: { classPropertyName: "disabled", publicName: "disabled", isSignal: true, isRequired: false, transformFunction: null }, required: { classPropertyName: "required", publicName: "required", isSignal: true, isRequired: false, transformFunction: null }, readOnly: { classPropertyName: "readOnly", publicName: "readOnly", isSignal: true, isRequired: false, transformFunction: null }, error: { classPropertyName: "error", publicName: "error", isSignal: true, isRequired: false, transformFunction: null }, trimOnBlur: { classPropertyName: "trimOnBlur", publicName: "trimOnBlur", isSignal: true, isRequired: false, transformFunction: null }, autofocus: { classPropertyName: "autofocus", publicName: "autofocus", isSignal: true, isRequired: false, transformFunction: null }, spellcheck: { classPropertyName: "spellcheck", publicName: "spellcheck", isSignal: true, isRequired: false, transformFunction: null }, id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null }, name: { classPropertyName: "name", publicName: "name", isSignal: true, isRequired: false, transformFunction: null }, autocomplete: { classPropertyName: "autocomplete", publicName: "autocomplete", isSignal: true, isRequired: false, transformFunction: null }, minLength: { classPropertyName: "minLength", publicName: "minLength", isSignal: true, isRequired: false, transformFunction: null }, maxLength: { classPropertyName: "maxLength", publicName: "maxLength", isSignal: true, isRequired: false, transformFunction: null }, ariaLabel: { classPropertyName: "ariaLabel", publicName: "ariaLabel", isSignal: true, isRequired: false, transformFunction: null }, ariaDescribedby: { classPropertyName: "ariaDescribedby", publicName: "ariaDescribedby", isSignal: true, isRequired: false, transformFunction: null }, dataCy: { classPropertyName: "dataCy", publicName: "dataCy", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { value: "valueChange", changed: "changed", focused: "focused", blurred: "blurred", keyDown: "keyDown" }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => VoteyTextareaComponent),
                multi: true,
            },
        ], viewQueries: [{ propertyName: "textareaElement", first: true, predicate: ["textareaElement"], descendants: true, isSignal: true }], ngImport: i0, template: "<div [class]=\"textareaClasses()\">\n  @if (labelVisible()) {\n    <label class=\"label\" [for]=\"resolvedId()\">{{ label() }}</label>\n  }\n\n  <div class=\"field\">\n    <textarea\n      #textareaElement\n      class=\"control\"\n      [id]=\"resolvedId()\"\n      [name]=\"name()\"\n      [value]=\"value()\"\n      [placeholder]=\"placeholder()\"\n      [disabled]=\"effectiveDisabled()\"\n      [required]=\"required()\"\n      [readOnly]=\"readOnly()\"\n      [spellcheck]=\"spellcheck()\"\n      [attr.autocomplete]=\"autocomplete() || null\"\n      [attr.autofocus]=\"autofocus() ? '' : null\"\n      [attr.minlength]=\"minLength()\"\n      [attr.maxlength]=\"maxLength()\"\n      [attr.aria-label]=\"resolvedAriaLabel()\"\n      [attr.aria-invalid]=\"error() ? true : null\"\n      [attr.aria-describedby]=\"resolvedAriaDescribedby()\"\n      [attr.aria-errormessage]=\"error() && helperVisible() ? helperId() : null\"\n      [attr.data-cy]=\"dataCy() || null\"\n      (input)=\"handleInput($event)\"\n      (focus)=\"handleFocus($event)\"\n      (blur)=\"handleBlur($event)\"\n      (keydown)=\"handleKeyDown($event)\"\n    ></textarea>\n  </div>\n\n  @if (helperVisible()) {\n    <span\n      class=\"helper\"\n      [id]=\"helperId()\"\n      [attr.role]=\"error() ? 'alert' : null\"\n      [attr.aria-live]=\"error() ? 'polite' : null\"\n    >\n      {{ helper() }}\n    </span>\n  }\n</div>\n", styles: [":host{display:block;width:100%}.textarea{display:flex;flex-direction:column;align-items:stretch;gap:var(--spacing-8);width:100%}.textarea .label{color:var(--color-text-secondary);font-family:var(--typo-input-label-font-family);font-size:var(--typo-input-label-font-size);font-weight:var(--typo-input-label-font-weight);letter-spacing:var(--typo-input-label-letter-spacing);line-height:var(--typo-input-label-line-height)}.textarea .field{box-sizing:border-box;width:100%;height:120px;min-height:120px;padding:calc(var(--spacing-12) + var(--spacing-2)) var(--spacing-16);overflow:hidden;border:1px solid var(--color-border-subtle);border-radius:var(--radius-input);background-color:var(--color-bg-surface);transition:background-color .18s ease,border-color .18s ease,box-shadow .18s ease}.textarea .field:focus-within{border-color:var(--color-accent-primary);box-shadow:inset 0 0 0 1px var(--color-accent-primary)}.textarea .field .control{display:block;box-sizing:border-box;width:100%;height:100%;padding:0;overflow:auto;border:0;outline:0;resize:none;background:transparent;color:var(--color-text-primary);font-family:var(--typo-body-font-family);font-size:var(--typo-body-font-size);font-weight:var(--typo-body-font-weight);letter-spacing:var(--typo-body-letter-spacing);line-height:var(--typo-body-line-height)}.textarea .field .control::placeholder{color:var(--color-text-muted);opacity:1}.textarea .helper{color:var(--color-text-muted);font-family:var(--typo-caption-s-font-family);font-size:var(--typo-caption-s-font-size);font-weight:var(--typo-caption-s-font-weight);letter-spacing:var(--typo-caption-s-letter-spacing);line-height:var(--typo-caption-s-line-height)}.textarea.filled .field{border-color:var(--color-border-strong)}.textarea.filled .field:focus-within{border-color:var(--color-accent-primary);box-shadow:inset 0 0 0 1px var(--color-accent-primary)}.textarea.error .field,.textarea.error .field:focus-within{border-color:var(--color-state-error);box-shadow:none}.textarea.error .helper{color:var(--color-state-error)}.textarea.disabled .field,.textarea.disabled .field:focus-within{border-color:var(--color-border-subtle);background-color:var(--color-bg-surface-tint);box-shadow:none}.textarea.disabled .field .control,.textarea.disabled .field:focus-within .control{color:var(--color-text-muted);cursor:not-allowed}@media(prefers-reduced-motion:reduce){.textarea .field{transition:none}}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyTextareaComponent, decorators: [{
            type: Component,
            args: [{ selector: "vt-textarea", changeDetection: ChangeDetectionStrategy.OnPush, providers: [
                        {
                            provide: NG_VALUE_ACCESSOR,
                            useExisting: forwardRef(() => VoteyTextareaComponent),
                            multi: true,
        ...
        }], propDecorators: { value: [{ type: i0.Input, args: [{ isSignal: true, alias: "value", required: false }] }, { type: i0.Output, args: ["valueChange"] }], label: [{ type: i0.Input, args: [{ isSignal: true, alias: "label", required: false }] }], placeholder: [{ type: i0.Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], helper: [{ type: i0.Input, args: [{ isSignal: true, alias: "helper", required: false }] }], showLabel: [{ type: i0.Input, args: [{ isSignal: true, alias: "showLabel", required: false }] }], showHelper: [{ type: i0.Input, args: [{ isSignal: true, alias: "showHelper", required: false }] }], disabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], required: [{ type: i0.Input, args: [{ isSignal: true, alias: "required", required: false }] }], readOnly: [{ type: i0.Input, args: [{ isSignal: true, alias: "readOnly", required: false }] }], error: [{ type: i0.Input, args: [{ isSignal: true, alias: "error", required: false }] }], trimOnBlur: [{ type: i0.Input, args: [{ isSignal: true, alias: "trimOnBlur", required: false }] }], autofocus: [{ type: i0.Input, args: [{ isSignal: true, alias: "autofocus", required: false }] }], spellcheck: [{ type: i0.Input, args: [{ isSignal: true, alias: "spellcheck", required: false }] }], id: [{ type: i0.Input, args: [{ isSignal: true, alias: "id", required: false }] }], name: [{ type: i0.Input, args: [{ isSignal: true, alias: "name", required: false }] }], autocomplete: [{ type: i0.Input, args: [{ isSignal: true, alias: "autocomplete", required: false }] }], minLength: [{ type: i0.Input, args: [{ isSignal: true, alias: "minLength", required: false }] }], maxLength: [{ type: i0.Input, args: [{ isSignal: true, alias: "maxLength", required: false }] }], ariaLabel: [{ type: i0.Input, args: [{ isSignal: true, alias: "ariaLabel", required: false }] }], ariaDescribedby: [{ type: i0.Input, args: [{ isSignal: true, alias: "ariaDescribedby", required: false }] }], dataCy: [{ type: i0.Input, args: [{ isSignal: true, alias: "dataCy", required: false }] }], changed: [{ type: i0.Output, args: ["changed"] }], focused: [{ type: i0.Output, args: ["focused"] }], blurred: [{ type: i0.Output, args: ["blurred"] }], keyDown: [{ type: i0.Output, args: ["keyDown"] }], textareaElement: [{ type: i0.ViewChild, args: ["textareaElement", { isSignal: true }] }] } });
