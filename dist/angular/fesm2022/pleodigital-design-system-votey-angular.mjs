...
import { InjectionToken, inject, PLATFORM_ID, Injectable, makeEnvironmentProviders, provideEnvironmentInitializer, input, ChangeDetectionStrategy, Component, Pipe, numberAttribute, computed, output, viewChildren, signal, Input, Directive, model, ViewEncapsulation, booleanAttribute, viewChild, TemplateRef, contentChildren } from '@angular/core';
...
class VoteyFilePickerComponent extends VoteyFormControlApplyDirective {
    ...
    effectiveDisabled = computed(() => this.disabled() || this.formDisabled() || this.isLoading(), ...(ngDevMode ? [{ debugName: "effectiveDisabled" }] : /* istanbul ignore next */ []));
    isRequired = computed(() => {
...
class VoteySelectComponent extends VoteyFormControlApplyDirective {
    ...
    get selectedOptions() {
        ...
        return this.options().filter((option) => selectedValues.some((value) => Object.is(value, option.value)));
    }
    get errorKeys() {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: VoteySelectComponent, isStandalone: true, selector: "vt-select", inputs: { options: { classPropertyName: "options", publicName: "options", isSignal: true, isRequired: true, transformFunction: null }, variant: { classPropertyName: "variant", publicName: "variant", isSignal: true, isRequired: false, transformFunction: null }, label: { classPropertyName: "label", publicName: "label", isSignal: true, isRequired: false, transformFunction: null }, placeholder: { classPropertyName: "placeholder", publicName: "placeholder", isSignal: true, isRequired: false, transformFunction: null }, id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null }, name: { classPropertyName: "name", publicName: "name", isSignal: true, isRequired: false, transformFunction: null }, dataCy: { classPropertyName: "dataCy", publicName: "dataCy", isSignal: true, isRequired: false, transformFunction: null }, multiple: { classPropertyName: "multiple", publicName: "multiple", isSignal: true, isRequired: false, transformFunction: null }, disabled: { classPropertyName: "disabled", publicName: "disabled", isSignal: true, isRequired: false, transformFunction: null }, showSelectionChips: { classPropertyName: "showSelectionChips", publicName: "showSelectionChips", isSignal: true, isRequired: false, transformFunction: null }, removeTooltip: { classPropertyName: "removeTooltip", publicName: "removeTooltip", isSignal: true, isRequired: false, transformFunction: null }, ignoredErrors: { classPropertyName: "ignoredErrors", publicName: "ignoredErrors", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { selectionChange: "selectionChange" }, usesInheritance: true, ngImport: i0, template: "@let translatedLabel = label() | vtTranslate; @let selectDisabled = disabled()\n|| formControl.disabled;\n\n<div\n  class=\"select-wrapper\"\n  [class.compact]=\"variant() === 'compact'\"\n  [class.disabled]=\"selectDisabled\"\n  [class.error]=\"hasError\"\n>\n  @if (label()) {\n  <label class=\"label\" [for]=\"id()\">\n    <vt-text variant=\"label\" color=\"secondary\" [content]=\"translatedLabel\" />\n  </label>\n  }\n\n  <div class=\"field\">\n    <mat-select\n      class=\"control\"\n      panelClass=\"vt-select-panel\"\n      [id]=\"id()\"\n      [multiple]=\"multiple()\"\n      [disabled]=\"selectDisabled\"\n      [required]=\"isRequired\"\n      [formControl]=\"formControl\"\n      [placeholder]=\"placeholder() | vtTranslate\"\n      [attr.data-cy]=\"dataCy() || null\"\n      [attr.name]=\"name() || null\"\n      (selectionChange)=\"handleSelectionChange($event)\"\n    >\n      @for (option of options(); track option.value) {\n      <mat-option [value]=\"option.value\" [disabled]=\"option.disabled ?? false\">\n        {{ option.label | vtTranslate }}\n      </mat-option>\n      }\n    </mat-select>\n  </div>\n\n  @if (multiple() && showSelectionChips() && selectedOptions.length) {\n  <div class=\"chips\">\n    @for (option of selectedOptions; track option.value) {\n    <vt-chip\n      [label]=\"option.label | vtTranslate\"\n      [removeTooltip]=\"removeTooltip()\"\n      [disabled]=\"selectDisabled || (option.disabled ?? false)\"\n      (removed)=\"removeSelection(option)\"\n    />\n    }\n  </div>\n  }\n\n  <vt-form-error [errors]=\"errorKeys\" [ignoredErrors]=\"ignoredErrors()\" />\n</div>\n", styles: ["vt-select{display:block;width:100%}vt-select .select-wrapper{display:flex;flex-direction:column;align-items:stretch;gap:var(--spacing-8);width:100%}vt-select .select-wrapper .label{display:contents}vt-select .select-wrapper .field{box-sizing:border-box;display:flex;align-items:center;width:100%;height:50px;padding:0 var(--spacing-16);border:1px solid var(--color-border-subtle);border-radius:var(--radius-input);background-color:var(--color-bg-surface);transition:background-color .18s ease,border-color .18s ease,box-shadow .18s ease}vt-select .select-wrapper .field:focus-within{border-color:var(--color-accent-primary);box-shadow:inset 0 0 0 1px var(--color-accent-primary)}vt-select .select-wrapper .field .control{width:100%;color:var(--color-text-primary);font-family:var(--typo-field-font-family);font-size:var(--typo-field-font-size);font-weight:var(--typo-field-font-weight);letter-spacing:var(--typo-field-letter-spacing);line-height:var(--typo-field-line-height)}vt-select .select-wrapper .field .control .mat-mdc-select-placeholder,vt-select .select-wrapper .field .control .mat-mdc-select-arrow{color:var(--color-text-muted)}vt-select .select-wrapper .chips{display:flex;flex-wrap:wrap;gap:var(--spacing-8)}vt-select .select-wrapper.compact .field{height:30px;padding:0 var(--spacing-12);border-radius:var(--radius-pill)}vt-select .select-wrapper.error .field,vt-select .select-wrapper.error .field:focus-within{border-color:var(--color-state-error);box-shadow:none}vt-select .select-wrapper.disabled .field,vt-select .select-wrapper.disabled .field:focus-within{border-color:var(--color-border-subtle);background-color:var(--color-bg-surface-tint);box-shadow:none}vt-select .select-wrapper.disabled .field .control,vt-select .select-wrapper.disabled .field:focus-within .control{color:var(--color-text-muted)}.vt-select-panel{border-radius:var(--radius-input)!important;background-color:var(--color-bg-surface)!important}.vt-select-panel .mat-mdc-option{color:var(--color-text-primary);font-family:var(--typo-field-font-family);font-size:var(--typo-field-font-size);font-weight:var(--typo-field-font-weight);letter-spacing:var(--typo-field-letter-spacing);line-height:var(--typo-field-line-height)}.vt-select-panel .mat-mdc-option:hover:not(.mdc-list-item--disabled),.vt-select-panel .mat-mdc-option.mat-mdc-option-active:not(.mdc-list-item--disabled),.vt-select-panel .mat-mdc-option.mdc-list-item--selected:not(.mdc-list-item--disabled){background-color:var(--color-accent-soft)}.vt-select-panel .mat-mdc-option.mdc-list-item--disabled{color:var(--color-text-muted)}\n"], dependencies: [{ kind: "component", type: MatOption, selector: "mat-option", inputs: ["value", "id", "disabled"], outputs: ["onSelectionChange"], exportAs: ["matOption"] }, { kind: "component", type: MatSelect, selector: "mat-select", inputs: ["aria-describedby", "panelClass", "disabled", "disableRipple", "tabIndex", "hideSingleSelectionIndicator", "placeholder", "required", "multiple", "disableOptionCentering", "compareWith", "value", "aria-label", "aria-labelledby", "errorStateMatcher", "typeaheadDebounceInterval", "sortComparator", "id", "panelWidth", "canSelectNullableOptions"], outputs: ["openedChange", "opened", "closed", "selectionChange", "valueChange"], exportAs: ["matSelect"] }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i1.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { kind: "directive", type: i1.FormControlDirective, selector: "[formControl]", inputs: ["formControl", "disabled", "ngModel"], outputs: ["ngModelChange"], exportAs: ["ngForm"] }, { kind: "component", type: VoteyChipComponent, selector: "vt-chip", inputs: ["label", "removeTooltip", "showRemove", "disabled"], outputs: ["removed"] }, { kind: "component", type: VoteyFormErrorComponent, selector: "vt-form-error", inputs: ["errors", "ignoredErrors"] }, { kind: "component", type: VoteyTextComponent, selector: "vt-text", inputs: ["content", "variant", "color", "uppercase", "italic", "wrap", "maxLines"] }, { kind: "pipe", type: VoteyTranslatePipe, name: "vtTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteySelectComponent, decorators: [{
        ...
        }], propDecorators: { options: [{ type: i0.Input, args: [{ isSignal: true, alias: "options", required: true }] }], variant: [{ type: i0.Input, args: [{ isSignal: true, alias: "variant", required: false }] }], label: [{ type: i0.Input, args: [{ isSignal: true, alias: "label", required: false }] }], placeholder: [{ type: i0.Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], id: [{ type: i0.Input, args: [{ isSignal: true, alias: "id", required: false }] }], name: [{ type: i0.Input, args: [{ isSignal: true, alias: "name", required: false }] }], dataCy: [{ type: i0.Input, args: [{ isSignal: true, alias: "dataCy", required: false }] }], multiple: [{ type: i0.Input, args: [{ isSignal: true, alias: "multiple", required: false }] }], disabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], showSelectionChips: [{ type: i0.Input, args: [{ isSignal: true, alias: "showSelectionChips", required: false }] }], removeTooltip: [{ type: i0.Input, args: [{ isSignal: true, alias: "removeTooltip", required: false }] }], ignoredErrors: [{ type: i0.Input, args: [{ isSignal: true, alias: "ignoredErrors", required: false }] }], selectionChange: [{ type: i0.Output, args: ["selectionChange"] }] } });
