...
class VoteyChipComponent {
    ...
    removeAriaLabel = input.required(...(ngDevMode ? [{ debugName: "removeAriaLabel" }] : /* istanbul ignore next */ []));
    showRemove = input(true, ...(ngDevMode ? [{ debugName: "showRemove" }] : /* istanbul ignore next */ []));
    disabled = input(false, ...(ngDevMode ? [{ debugName: "disabled" }] : /* istanbul ignore next */ []));
    removed = output();
    textColor = computed(() => (this.disabled() ? "muted" : "primary"), ...(ngDevMode ? [{ debugName: "textColor" }] : /* istanbul ignore next */ []));
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: VoteyChipComponent, isStandalone: true, selector: "vt-chip", inputs: { label: { classPropertyName: "label", publicName: "label", isSignal: true, isRequired: true, transformFunction: null }, removeAriaLabel: { classPropertyName: "removeAriaLabel", publicName: "removeAriaLabel", isSignal: true, isRequired: true, transformFunction: null }, showRemove: { classPropertyName: "showRemove", publicName: "showRemove", isSignal: true, isRequired: false, transformFunction: null }, disabled: { classPropertyName: "disabled", publicName: "disabled", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { removed: "removed" }, ngImport: i0, template: "<span\n  class=\"chip\"\n  [class.disabled]=\"disabled()\"\n  [attr.aria-disabled]=\"disabled()\"\n>\n  <vt-text\n    variant=\"caption\"\n    [content]=\"label()\"\n    [color]=\"textColor()\"\n  />\n  @if (showRemove()) {\n    <button\n      class=\"remove\"\n      type=\"button\"\n      [disabled]=\"disabled()\"\n      [attr.aria-label]=\"removeAriaLabel()\"\n      (click)=\"removed.emit()\"\n    ></button>\n  }\n</span>\n", styles: [":host{display:inline-flex}.chip{box-sizing:border-box;display:inline-flex;align-items:center;gap:var(--spacing-8);min-width:0;padding:var(--spacing-4) calc(var(--spacing-8) + var(--spacing-2)) var(--spacing-4) var(--spacing-12);border-radius:var(--radius-pill);background-color:var(--color-accent-soft);box-shadow:inset 0 0 0 2px var(--color-accent-hover);white-space:nowrap}.chip .remove{position:relative;display:inline-flex;flex:0 0 10px;align-items:center;justify-content:center;width:10px;height:10px;padding:0;border:0;background:none;color:var(--color-text-primary);cursor:pointer}.chip .remove:before,.chip .remove:after{content:\"\";position:absolute;top:50%;left:50%;width:14px;height:2px;border-radius:var(--radius-pill);background-color:currentColor}.chip .remove:before{transform:translate(-50%,-50%) rotate(45deg)}.chip .remove:after{transform:translate(-50%,-50%) rotate(-45deg)}.chip.disabled{background-color:var(--color-bg-surface-tint);box-shadow:inset 0 0 0 2px var(--color-border-subtle)}.chip.disabled .remove{color:var(--color-text-muted);cursor:not-allowed}\n"], dependencies: [{ kind: "component", type: VoteyTextComponent, selector: "vt-text", inputs: ["content", "variant", "color", "uppercase", "italic", "wrap", "maxLines"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyChipComponent, decorators: [{
            type: Component,
            args: [{ selector: "vt-chip", changeDetection: ChangeDetectionStrategy.OnPush, imports: [VoteyTextComponent], template: "<span\n  class=\"chip\"\n  [class.disabled]=\"disabled()\"\n  [attr.aria-disabled]=\"disabled()\"\n>\n  <vt-text\n    variant=\"caption\"\n    [content]=\"label()\"\n    [color]=\"textColor()\"\n  />\n  @if (showRemove()) {\n    <button\n      class=\"remove\"\n      type=\"button\"\n      [disabled]=\"disabled()\"\n      [attr.aria-label]=\"removeAriaLabel()\"\n      (click)=\"removed.emit()\"\n    ></button>\n  }\n</span>\n", styles: [":host{display:inline-flex}.chip{box-sizing:border-box;display:inline-flex;align-items:center;gap:var(--spacing-8);min-width:0;padding:var(--spacing-4) calc(var(--spacing-8) + var(--spacing-2)) var(--spacing-4) var(--spacing-12);border-radius:var(--radius-pill);background-color:var(--color-accent-soft);box-shadow:inset 0 0 0 2px var(--color-accent-hover);white-space:nowrap}.chip .remove{position:relative;display:inline-flex;flex:0 0 10px;align-items:center;justify-content:center;width:10px;height:10px;padding:0;border:0;background:none;color:var(--color-text-primary);cursor:pointer}.chip .remove:before,.chip .remove:after{content:\"\";position:absolute;top:50%;left:50%;width:14px;height:2px;border-radius:var(--radius-pill);background-color:currentColor}.chip .remove:before{transform:translate(-50%,-50%) rotate(45deg)}.chip .remove:after{transform:translate(-50%,-50%) rotate(-45deg)}.chip.disabled{background-color:var(--color-bg-surface-tint);box-shadow:inset 0 0 0 2px var(--color-border-subtle)}.chip.disabled .remove{color:var(--color-text-muted);cursor:not-allowed}\n"] }]
        }], propDecorators: { label: [{ type: i0.Input, args: [{ isSignal: true, alias: "label", required: true }] }], removeAriaLabel: [{ type: i0.Input, args: [{ isSignal: true, alias: "removeAriaLabel", required: true }] }], showRemove: [{ type: i0.Input, args: [{ isSignal: true, alias: "showRemove", required: false }] }], disabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], removed: [{ type: i0.Output, args: ["removed"] }] } });
