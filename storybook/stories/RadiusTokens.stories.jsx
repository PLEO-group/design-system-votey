...
import './RadiusTokens.stories.css';
...
function RadiusCard({label, token, semantic = false}) {
    ...
    return (
        <article className="radius-tokens__card">
            <div
                className={`radius-tokens__shape radius-tokens__shape--${token}`}
                style={{borderRadius: `var(${property})`}}
            />
            <div className="radius-tokens__details">
...
function RadiusTokens() {
    return (
        <main className="radius-tokens">
            ...
            <section className="radius-tokens__section">
                <div className="radius-tokens__section-heading">
                    <div><span>Core</span><h2>Radius scale</h2></div>
                    <p>Fixed primitive values used by semantic radius roles.</p>
                </div>
                <div className="radius-tokens__grid">
