...
class VoteySelectComponent extends VoteyFormControlApplyDirective {
    ...
    resolvedTooltip = computed(() => (this.disabled() || this.formControl.disabled
        ? this.disabledNote()
        : this.tooltip()).trim(), ...(ngDevMode ? [{ debugName: "resolvedTooltip" }] : /* istanbul ignore next */ []));
    get isRequired() {
        return this.formControl.hasValidator(Validators.required);
    }
    get hasError() {
