...
declare const VoteyFilePickerVariants: readonly ["compact", "dropzone"];
declare const VoteyFilePickerFileStates: readonly ["done", "uploading", "error"];
type VoteyFilePickerVariant = (typeof VoteyFilePickerVariants)[number];
type VoteyFilePickerFileState = (typeof VoteyFilePickerFileStates)[number];
