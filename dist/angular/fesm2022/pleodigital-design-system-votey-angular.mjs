...
class VoteyInputComponent {
    ...
    inputClasses = computed(() => [
        ...
        .filter(Boolean)
        .join(" "), ...(ngDevMode ? [{ debugName: "inputClasses" }] : /* istanbul ignore next */ []));
    onChange = () => undefined;
    onTouched = () => undefined;
    writeValue(value) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: VoteyInputComponent, decorators: [{
            type: Component,
            args: [{ selector: "vt-input", changeDetection: ChangeDetectionStrategy.OnPush, imports: [VoteyIconComponent], providers: [
                        {
                            provide: NG_VALUE_ACCESSOR,
                            useExisting: forwardRef(() => VoteyInputComponent),
                            multi: true,
