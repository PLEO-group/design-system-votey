...
import { InjectionToken, inject, PLATFORM_ID, Injectable, makeEnvironmentProviders, provideEnvironmentInitializer, input, ChangeDetectionStrategy, Component, Pipe, numberAttribute, computed, output, viewChildren, signal, Input, Directive, model, ViewEncapsulation, booleanAttribute, viewChild, DestroyRef, TemplateRef, contentChildren } from '@angular/core';
