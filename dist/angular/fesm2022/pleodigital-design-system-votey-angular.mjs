...
const VoteyFilePickerVariants = ["compact", "dropzone"];
const VoteyFilePickerFileStates = [
    "done",
    "uploading",
    "error",
];
...
class VoteyFilePickerComponent extends VoteyFormControlApplyDirective {
    variantNames = {
        compact: VoteyFilePickerVariants[0],
        dropzone: VoteyFilePickerVariants[1],
    };
    fileStateNames = {
        done: VoteyFilePickerFileStates[0],
        uploading: VoteyFilePickerFileStates[1],
        error: VoteyFilePickerFileStates[2],
    };
    ...
    effectiveMultiple = computed(() => this.isDropzone() || this.multiple(), ...(ngDevMode ? [{ debugName: "effectiveMultiple" }] : /* istanbul ignore next */ []));
