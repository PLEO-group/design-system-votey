...
import { InjectionToken, inject, PLATFORM_ID, Injectable, makeEnvironmentProviders, provideEnvironmentInitializer, input, ChangeDetectionStrategy, Component, Pipe, numberAttribute, computed, output, viewChildren, signal, model, forwardRef, ViewEncapsulation, TemplateRef, Directive, contentChildren } from '@angular/core';
...
class VoteyMenuComponent {
    ...
    ariaLabel = input("Menu", ...(ngDevMode ? [{ debugName: "ariaLabel" }] : /* istanbul ignore next */ []));
    ...
    resolvedAriaLabel = computed(() => (this.ariaLabelledby() ? null : this.ariaLabel()), ...(ngDevMode ? [{ debugName: "resolvedAriaLabel" }] : /* istanbul ignore next */ []));
