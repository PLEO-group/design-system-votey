...
import { InjectionToken, inject, PLATFORM_ID, Injectable, makeEnvironmentProviders, provideEnvironmentInitializer, input, ChangeDetectionStrategy, Component, Pipe, output, computed, model, signal, forwardRef, ViewEncapsulation, TemplateRef, Directive, contentChildren, numberAttribute } from '@angular/core';
